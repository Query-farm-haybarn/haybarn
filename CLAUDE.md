...
| build identity: detection macros | `src/include/duckdb/haybarn.h` (new), `src/include/duckdb.hpp` (1-line `#include`), `src/include/duckdb/main/capi/header_generation/header_base.hpp.template` (inlined for the autogenerated `src/include/duckdb.h`) |
