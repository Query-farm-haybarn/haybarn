...
Assume the current Haybarn branch is based on `v1.5.2` and we are moving to
`vX.Y.Z`.
...
git rebase --onto vX.Y.Z v1.5.2 haybarn
```
...
1. Update the embedded version references that mention `1.5.2`:
